...
public class SessionsActivity extends AppCompatActivity {
    ...
    private void prepareListData() {
        ...
        may22.add("10:00 - 11:00    Data Fabric");
        may22.add("11:00 - 12:00    Snapcenter update");
        may22.add("13:00 - 14:00    Cloud Data Services");
        may22.add("14:00 - 15:00    HCI");
        may22.add("15:00 - 16:00    NFLEX");
        ...
        may23.add("10:00 - 11:00    Data Fabric");
        may23.add("11:00 - 12:00    Snapcenter update");
        may23.add("13:00 - 14:00    Cloud Data Services");
        may23.add("14:00 - 15:00    HCI");
        may23.add("15:00 - 16:00    NFLEX");
